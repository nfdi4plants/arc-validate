...
#r "/Users/lux/Documents/GitHub/ARCTokenization/src/ARCTokenization/bin/Release/netstandard2.0/ControlledVocabulary.dll"
...
#r "/Users/lux/Documents/GitHub/arc-validate/src/arc-validate/bin/Release/net8.0/ARCtrl.FileSystem.dll"
#r "/Users/lux/Documents/GitHub/arc-validate/src/arc-validate/bin/Release/net8.0/ARCtrl.ISA.dll"
#r "/Users/lux/Documents/GitHub/arc-validate/src/arc-validate/bin/Release/net8.0/ARCtrl.ISA.Spreadsheet.dll"
#r "/Users/lux/Documents/GitHub/arc-validate/src/arc-validate/bin/Release/net8.0/ARCValidationPackages.dll" 
#r "/Users/lux/Documents/GitHub/arc-validate/src/arc-validate/bin/Release/net8.0/ARCExpect.dll" 
...
module isalight =
    ...
    let arcDir =   "/Users/lux/Documents/MSPracticalCourse2024"// "/Users/christopherlux/Documents/ArcPrototype"
    //let arcDir =  "/Users/christopherlux/Documents/MSPracticalCourse2024"
    let outDirResXml = System.IO.Path.Combine(arcDir, "prototype_validation.xml")
    let outDirBadge = System.IO.Path.Combine(arcDir, "prototype_validation.svg")
    ...
    let checkForParam (expectedParam : CvTerm) (paramCollection : #seq<#IParam>) = 
        let tmp = 
            expectedParam.Accession
        paramCollection
        |> Seq.exists(fun x -> (Param.getCvAccession x = tmp))

    open InvestigationHelper
    open StudyHelper
    open AssayHelper
    ...
    //ARCExpect.Execute.ValidationPipeline(outDirResXml, outDirBadge) cases