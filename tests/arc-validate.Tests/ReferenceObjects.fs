...
let ``test_py_package_script_content_v0.0.2`` = "PACKAGE_METADATA = \"\"\"
---
Name: test-py
MajorVersion: 0
MinorVersion: 0
...
print(\"If you can read this in your console, you are executing test-py package v0.0.2!\")".ReplaceLineEndings("\n")
